...
struct BeatriceLibData {
    ...
    phone_context: *mut Beatrice20a2_PhoneContext1,
    pitch_context: *mut Beatrice20a2_PitchContext1,
    waveform_context: *mut Beatrice20a2_WaveformContext1,
}
...
impl BeatriceBeta0 {
    ...
    pub fn new() -> BeatriceBeta0 {
        let lib = unsafe {
            BeatriceLibData {
                phone_extractor: Beatrice20a2_CreatePhoneExtractor(),
                pitch_estimator: Beatrice20a2_CreatePitchEstimator(),
                waveform_generator: Beatrice20a2_CreateWaveformGenerator(),
                phone_context: Beatrice20a2_CreatePhoneContext1(),
                pitch_context: Beatrice20a2_CreatePitchContext1(),
                waveform_context: Beatrice20a2_CreateWaveformContext1(),
            }
        };
    ...
    pub fn load_model(&mut self, model_path: impl AsRef<Path>) -> Result<(), BeatriceError> {
        ...
        let mut speaker_embeddings = vec![];
        {
            ...
            let result = unsafe {
                Beatrice20a2_ReadNSpeakers(file_name.as_ptr(), &mut self.info.n_speakers)
            };
            ...
            let result = unsafe {
                Beatrice20a2_ReadSpeakerEmbeddings(
                    file_name.as_ptr(),
    ...
    pub fn reset_context(&mut self) {
        unsafe {
            let phone_context = Beatrice20a2_CreatePhoneContext1();
            let pitch_context = Beatrice20a2_CreatePitchContext1();
            let waveform_context = Beatrice20a2_CreateWaveformContext1();
            ...
            Beatrice20a2_DestroyPhoneContext1(old_phone_ctx);
            Beatrice20a2_DestroyPitchContext1(old_pitch_ctx);
            Beatrice20a2_DestroyWaveformContext1(old_waveform_ctx);
        }
    }
    ...
    fn infer_slice(
        ...
        let mut phone = [0.0_f32; BEATRICE_20A2_PHONE_CHANNELS];
        unsafe {
            Beatrice20a2_ExtractPhone1(
                self.lib.phone_extractor,
                input.as_ptr(),
                phone.as_mut_ptr(),
        ...
        quantized_pitch = {
            ...
            rounded.clamp(1, BEATRICE_20A2_PITCH_BINS as i32 - 1)
        };
        ...
        unsafe {
            Beatrice20a2_GenerateWaveform1(
                self.lib.waveform_generator,
                phone.as_ptr(),
                &quantized_pitch,
...
unsafe impl Send for BeatriceBeta0 {}

impl Drop for BeatriceBeta0 {
    fn drop(&mut self) {
        unsafe {
            Beatrice20a2_DestroyPhoneExtractor(self.lib.phone_extractor);
            Beatrice20a2_DestroyPitchEstimator(self.lib.pitch_estimator);
            Beatrice20a2_DestroyWaveformGenerator(self.lib.waveform_generator);
            Beatrice20a2_DestroyPhoneContext1(self.lib.phone_context);
            Beatrice20a2_DestroyPitchContext1(self.lib.pitch_context);
            Beatrice20a2_DestroyWaveformContext1(self.lib.waveform_context)
        }
    }
}
